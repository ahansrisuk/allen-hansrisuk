...
const Header = ({ siteTitle }) => {
    ...
    return (
        <header className="fixed top-0 right-0 left-0 sm:w-5/6 max-w-screen-xl m-auto pt-6 block sm:flex justify-between content-center z-10 text-xs sm:text-lg md:text-xl lg:text-2xl">
